...
APP_RUNTIME_SCRIPTS: tuple[str, ...] = (
    ...
    "source_sync_shard_gc.py",
    "source_sync_shard_manifest.py",
    "source_sync_shard_model.py",
    "source_sync_shard_progress.py",
    "source_sync_shard_remote.py",
    "source_sync_snapshot.py",
    "source_sync_snapshot_push.py",
    "source_sync_snapshot_push_retry.py",
    "source_sync_snapshot_remote.py",
    "source_sync_snapshot_shard_metadata.py",
    "source_sync_snapshot_timing.py",
    "source_sync.py",
