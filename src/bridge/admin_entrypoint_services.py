...
class _PipelineServiceLike(Protocol):
    ...
    _load_json_object: Callable[..., Any]
...
class _DesktopUpdateServiceLike(Protocol):
    def get_status_payload(self) -> JsonObject: ...
    def check_for_update(self, *, force: bool = False) -> JsonObject: ...
    def download_update(self) -> JsonObject: ...
    def request_install(self) -> JsonObject: ...
...
class _OpsApiLike(Protocol):
    ...
    def compute_ops_health_ready(self) -> JsonObject: ...
