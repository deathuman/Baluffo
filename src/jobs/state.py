...
def should_skip_source_by_ttl(
    ...
    return _state_incremental.should_skip_source_by_ttl(source_name, state_rows, ttl_minutes)
...
def should_skip_source_by_cadence(
    ...
    *,
    ...
    return _state_incremental.should_skip_source_by_cadence(
        source_name,
        state_rows,
...
_adapter_for_cache = _state_incremental.adapter_for_cache
_decision_window_minutes = _state_incremental.decision_window_minutes
_compute_next_eligible_check_at = _state_incremental.compute_next_eligible_check_at
...
def get_incremental_cache_decision(
    ...
    *,
    ...
    return _state_incremental.get_incremental_cache_decision(
        source_name,
        state_rows,
        adapter=adapter,
