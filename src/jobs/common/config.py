...
DEFAULT_STATIC_LISTING_HTTP_TIMEOUT_S = 8
DEFAULT_STATIC_LISTING_BROWSER_TIMEOUT_S = 10
DEFAULT_STATIC_LISTING_TOTAL_BUDGET_S = 18
DEFAULT_STATIC_LISTING_RETRIES = 0
DEFAULT_STATIC_POST_LISTING_DETAIL_BUDGET_S = 8
