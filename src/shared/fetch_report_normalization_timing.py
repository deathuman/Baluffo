"""Fetch-report timing: stage totals, named durations, and finalization timing.

AI boundary owns: fetch-report timing-summary normalization and finalization stage timing.
AI boundary implement in: this leaf for timing normalization; row primitives stay in the fetch_report_normalization coordinator.
AI boundary search before contracts: bridge report normalizer, jobs report contracts, and timing tests.
