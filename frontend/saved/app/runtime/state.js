function createSavedDomState() {
  return {
    ...
    availabilityAttentionBannerEl: null,
    availabilityAttentionCountEl: null,
    availabilityAttentionFilterBtnEl: null,
    availabilityAttentionAcknowledgeAllBtnEl: null,
    savedSortBarEl: null,
    savedSortBtnEls: [],
...
function createSavedViewState({
  ...
  return {
    ...
    availabilityAttentionSummary: { count: 0, events: [] },
