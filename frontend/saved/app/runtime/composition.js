...
export function composeSavedRuntime(deps) {
  ...
  savedRenderController = createSavedRenderController({
    ...
    outcomeOptions: deps.outcomeOptions,
    outcomeLabels: deps.outcomeLabels,
    normalizePhase: deps.normalizePhase,
    normalizeOutcome: deps.normalizeOutcome,
    canTransitionPhase: deps.canTransitionPhase,
    canSetOutcome: deps.canSetOutcome,
    ...
    hydrateAttachmentListForJob: (...args) => savedAttachmentsController.hydrateAttachmentListForJob(...args),
  ...
  savedAuthController = createSavedAuthController({
    ...
    markSavedStep: (...args) => deps.markSavedStep(...args),
    measureSavedStep: (...args) => deps.measureSavedStep(...args),
    markSavedFirstRender: (...args) => deps.markSavedFirstRender(...args),
  ...
  return {
    ...
    normalizeOutcome: outcome => savedRenderController.normalizeOutcome(outcome),
    canTransition: (currentPhase, nextPhase, outcomeStatus = "active") => (
      savedRenderController.canTransition(currentPhase, nextPhase, outcomeStatus)
    ),
    canSetOutcome: (currentOutcome, nextOutcome) => savedRenderController.canSetOutcome(currentOutcome, nextOutcome),
    ...
    hydrateAttachmentListForJob: (jobKey, options = {}) => savedAttachmentsController.hydrateAttachmentListForJob(jobKey, options),
