...
| Live bridge contention burst sample | `python scripts/perf_bridge_profile_snapshot.py --bridge-base-url http://192.168.50.61:8877 --burst-rounds 5 --burst-concurrency 4` | Same live output, with read-only concurrent route p50/p95/max summaries |
