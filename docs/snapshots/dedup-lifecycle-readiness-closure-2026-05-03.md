...
> - **Then inspect:** [`../plans/dedup-current-run-blocker-review-plan.md`](../plans/dedup-current-run-blocker-review-plan.md), [`../source-policy-runbook.md`](../source-policy-runbook.md), and [`../DATA_CONTRACT.md`](../DATA_CONTRACT.md)
...
Active follow-up now lives in [`../plans/dedup-current-run-blocker-review-plan.md`](../plans/dedup-current-run-blocker-review-plan.md).
