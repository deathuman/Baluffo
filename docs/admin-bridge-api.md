...
| GET | `/registry/conflicts?view=summary` | Compact Admin startup conflict summary with counts, triage/review/automation summaries, registry summary, and a small sample without full evidence/cards |
