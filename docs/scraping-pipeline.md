...
Use this only as an operator validation path. It does not lower the runtime threshold, does not make cache skips count as successes, and does not change normal default fetch behavior.
