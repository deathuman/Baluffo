...
- Under this rule, `0.1.3` is newer than `0.1.24` through `0.1.29`, and the desktop updater, downgrade checks, recovery selection, and release tooling must all use the same ordering.
