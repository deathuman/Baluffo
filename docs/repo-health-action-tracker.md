...
4. **Raise coverage in the weakest validated modules.**
...
5. **Reduce JS hygiene noise before the next broad frontend refactor.**
...
6. **Add static security scanning to CI.**
...
7. **Evaluate a complexity gate after the first typing and hygiene pass.**
...
8. **Add real CI status badges to `README.md`.**
...
9. **Evaluate structured logging for support and ops diagnostics.**
