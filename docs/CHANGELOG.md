...
- Desktop bridge/update imports on the current public release line no longer trip a `src.ship.desktop_app` / `src.ship.desktop_update` import cycle during full runtime startup or release-preflight test collection.
