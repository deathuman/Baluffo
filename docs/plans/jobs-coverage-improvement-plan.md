...
collection, CDATA/dedupe/index handling, both `<title>` shapes, slug fallback, empty-signal None,
host gating, end-to-end row mapping, and the registry selection for widget-only hosts). Batteries:
