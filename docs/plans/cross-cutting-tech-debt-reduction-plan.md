...
**90 instances** of `except Exception`/`suppress(Exception)` across **50 source/tool files**:

- 90 with explicit annotation or `suppress(Exception)`, including 87 broad-catch `src` BLE001 sites and a guarded `src` BLE001 budget of 88
