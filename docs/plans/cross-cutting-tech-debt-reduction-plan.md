...
**96 instances** of `except Exception`/`suppress(Exception)` across **53 source/tool files**:

- 96 with explicit annotation or `suppress(Exception)`, including 93 broad-catch `src` BLE001 sites and a guarded `src` BLE001 budget of 94
