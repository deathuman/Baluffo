...
**91 instances** of `except Exception`/`suppress(Exception)` across **51 source/tool files**:

- 91 with explicit annotation or `suppress(Exception)`, including 88 broad-catch `src` BLE001 sites and a guarded `src` BLE001 budget of 89
