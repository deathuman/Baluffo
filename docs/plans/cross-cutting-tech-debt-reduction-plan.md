...
**133 instances** of `except Exception`/`suppress(Exception)` across **70 source/tool files**:

- 102 with `# noqa: BLE001` (explicit linter suppression), including 97 in the guarded `src` budget
