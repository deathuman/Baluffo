...
- Python runtime consumers inside `src/ship/`, build/portable scripts, and ship shell/PowerShell update entrypoints now import or invoke update-manager behavior through leaves; `update_manager.py` remains the canonical API compatibility facade.
