...
**147 instances** of `except Exception`/`suppress(Exception)` across **83 source/tool files**:

- 116 with `# noqa: BLE001` (explicit linter suppression), including 111 in the guarded `src` budget
