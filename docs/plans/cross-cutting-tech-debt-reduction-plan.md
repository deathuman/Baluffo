...
**136 instances** of `except Exception`/`suppress(Exception)` across **73 source/tool files**:

- 105 with `# noqa: BLE001` (explicit linter suppression), including 100 in the guarded `src` budget
