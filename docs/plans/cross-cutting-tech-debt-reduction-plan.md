...
**141 instances** of `except Exception`/`suppress(Exception)` across **78 source/tool files**:

- 110 with `# noqa: BLE001` (explicit linter suppression), including 105 in the guarded `src` budget
