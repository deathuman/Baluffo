...
| Bare `except Exception` | P0 | Partial | First suppression ratchet completed: two URL parsing fallbacks narrowed and BLE001 budget lowered from 129 to 127. Broader HTTP/process boundaries remain open. |
...
- `npm run test:py:extended` passed: `3451 passed, 1 skipped`
