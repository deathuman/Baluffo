...
**139 instances** of `except Exception`/`suppress(Exception)` across **76 source/tool files**:

- 108 with `# noqa: BLE001` (explicit linter suppression), including 103 in the guarded `src` budget
