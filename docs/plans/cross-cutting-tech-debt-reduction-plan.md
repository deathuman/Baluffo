...
| 12 | Service holder dataclass for admin_bridge singletons | §2 | 6 files | Done | Desktop-update, registry, sync, discovery, and pipeline holders completed; legacy globals still mirrored for compatibility |
