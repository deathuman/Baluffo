...
**135 instances** of `except Exception`/`suppress(Exception)` across **72 source/tool files**:

- 104 with `# noqa: BLE001` (explicit linter suppression), including 99 in the guarded `src` budget
