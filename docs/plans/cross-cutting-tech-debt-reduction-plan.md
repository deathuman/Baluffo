...
**134 instances** of `except Exception`/`suppress(Exception)` across **71 source/tool files**:

- 103 with `# noqa: BLE001` (explicit linter suppression), including 98 in the guarded `src` budget
