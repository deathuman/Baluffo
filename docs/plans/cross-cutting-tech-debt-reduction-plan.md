...
| Fetch report normalization duplicated | P0 | Partial | Shared-compatible task-progress, socialSummary, timingSummary, source-row base helpers, and bridge source-row enrichment helpers extracted while preserving bridge/jobs shape differences. Deeper jobs/bridge source-row convergence remains open. |
