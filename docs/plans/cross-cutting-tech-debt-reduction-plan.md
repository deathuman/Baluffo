...
**138 instances** of `except Exception`/`suppress(Exception)` across **75 source/tool files**:

- 107 with `# noqa: BLE001` (explicit linter suppression), including 102 in the guarded `src` budget
