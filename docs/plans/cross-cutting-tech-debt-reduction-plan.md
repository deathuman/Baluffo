...
**148 instances** of `except Exception`/`suppress(Exception)` across **84 source files**:

- 112 with `# noqa: BLE001` (explicit linter suppression)
- 70 without any annotation
