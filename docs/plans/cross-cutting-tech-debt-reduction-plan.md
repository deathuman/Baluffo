...
- Python runtime consumers inside `src/ship/` now import update-manager behavior through leaves; shell, script, and packaging entrypoints still use the canonical `update_manager.py` CLI/API facade.
