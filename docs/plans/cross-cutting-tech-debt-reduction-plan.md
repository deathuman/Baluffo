...
**140 instances** of `except Exception`/`suppress(Exception)` across **77 source/tool files**:

- 109 with `# noqa: BLE001` (explicit linter suppression), including 104 in the guarded `src` budget
