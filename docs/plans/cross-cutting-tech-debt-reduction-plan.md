...
**89 instances** of `except Exception`/`suppress(Exception)` across **50 source/tool files**:

- 89 with explicit annotation or `suppress(Exception)`, including 86 broad-catch `src` BLE001 sites and a guarded `src` BLE001 budget of 87
