...
**146 instances** of `except Exception`/`suppress(Exception)` across **82 source/tool files**:

- 115 with `# noqa: BLE001` (explicit linter suppression), including 110 in the guarded `src` budget
