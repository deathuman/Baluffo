...
**142 instances** of `except Exception`/`suppress(Exception)` across **79 source/tool files**:

- 111 with `# noqa: BLE001` (explicit linter suppression), including 106 in the guarded `src` budget
