...
**145 instances** of `except Exception`/`suppress(Exception)` across **81 source/tool files**:

- 114 with `# noqa: BLE001` (explicit linter suppression), including 109 in the guarded `src` budget
