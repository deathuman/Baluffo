...
| [`plans/dedup-provider-static-disagreement-reconciliation-plan.md`](plans/dedup-provider-static-disagreement-reconciliation-plan.md) | Plans / Follow-Ups | You are reconciling remaining provider/static disagreement blockers before read-only lifecycle UX can proceed |
...
| Decide lifecycle UX readiness | [`plans/dedup-provider-static-disagreement-reconciliation-plan.md`](plans/dedup-provider-static-disagreement-reconciliation-plan.md) | [`snapshots/dedup-google-sheets-role-bucket-audit-closure-2026-05-03.md`](snapshots/dedup-google-sheets-role-bucket-audit-closure-2026-05-03.md), [`source-policy-runbook.md`](source-policy-runbook.md), [`DATA_CONTRACT.md`](DATA_CONTRACT.md) |
