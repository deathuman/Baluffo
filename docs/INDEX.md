...
| [`plans/dedup-pressure-reduction-plan.md`](plans/dedup-pressure-reduction-plan.md) | Plans / Folded (2026-09-04) | Folded into [`plans/jobs-coverage-improvement-plan.md`](plans/jobs-coverage-improvement-plan.md) T4b after the 2026-09-04 validate-then-decide review; consult for dedup confidence-gate strategy and monitor-debt history only |
...
| [`archive/jobs-pipeline-memory-reduction-plan.md`](archive/jobs-pipeline-memory-reduction-plan.md) | Archived Closeout | Completed jobs-pipeline peak-RSS reduction (P1–P3 + streaming pass); reference for bench methodology, the alloc profiler, and deferred next fetch-side levers |
| [`archive/cross-cutting-tech-debt-reduction-plan.md`](archive/cross-cutting-tech-debt-reduction-plan.md) | Archived Closeout | What closed after the June 2026 P0 refactor pass, and the explicit non-goals recorded at closeout |
| [`archive/browser-fallback-pool-plan.md`](archive/browser-fallback-pool-plan.md) | Archived Implemented Plan | Historical design/bench evidence for pooled Chromium fallback and the `BALUFFO_BROWSER_POOL=0` kill switch; current behavior lives in [`scraping-pipeline.md`](scraping-pipeline.md) |
...
| [`snapshots/jobs-entry-validation-audit-2026-08-12.md`](snapshots/jobs-entry-validation-audit-2026-08-12.md) | Snapshots / Evidence | You are checking the current jobs feed coverage/trustiness/entry-quality baseline (July 2026 artifacts) or triaging non-game contamination, code-title leaks, or country-field issues |
...
| [`snapshots/workday-cxs-site-sweep-evidence-2026-09-05.md`](snapshots/workday-cxs-site-sweep-evidence-2026-09-05.md) | Snapshots / Evidence | You are checking the 2026-09-05 bounded Workday CXS site-id sweep evidence across the tencent/intel/lnw/sglottery/xboxgaming tenants — empty TiMi board, final Intel/L&W/SciGames holds, xboxgaming recovery, or the Grover Gaming staging lead |
| [`snapshots/sector-signal-contamination-2026-09-06.md`](snapshots/sector-signal-contamination-2026-09-06.md) | Snapshots / Evidence | You are checking the 2026-09-06 sector-signal contamination sweep — Game-row attribution by signal branch, the role-token URL-tautology finding (~7.7k rows incl. Apple/NVIDIA/Lockheed), WBD/Disney/itch.io static noise, the gamejobs listing-parser artifact follow-up, or corrections to T13's contamination mechanism notes |
| [`snapshots/widget-ats-sweep-2026-09-09.md`](snapshots/widget-ats-sweep-2026-09-09.md) | Snapshots / Evidence | You are checking the 2026-09-09 embedded-ATS widget sweep — the 232-signature/115-embed/18-Tier-1 findings, the executed 5-repair staging wave (Grand/RiftGaming/Weta/TornBanner/Voldex), the RiftGaming family correction, or the corrected Axes-in-Motion workable candidate |
...
| Improve provider discovery coverage | [`plans/jobs-coverage-improvement-plan.md`](plans/jobs-coverage-improvement-plan.md) | [`scraping-pipeline.md`](scraping-pipeline.md), [`source-policy-runbook.md`](source-policy-runbook.md), [`adapter-plugin-inventory.md`](adapter-plugin-inventory.md) |
