...
| [`plans/bridge-route-inventory-guardrail-plan.md`](plans/bridge-route-inventory-guardrail-plan.md) | Plans / Follow-Ups | You are implementing the immediate route inventory and guardrail work before broader bridge observability or payload refactors |
...
| Add bridge route inventory guardrails | [`plans/bridge-route-inventory-guardrail-plan.md`](plans/bridge-route-inventory-guardrail-plan.md) | [`admin-bridge-api.md`](admin-bridge-api.md), [`architecture-ai-map.md`](architecture-ai-map.md), [`testing.md`](testing.md) |
