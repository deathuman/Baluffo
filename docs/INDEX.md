...
| [`plans/read-only-lifecycle-ux-plan.md`](plans/read-only-lifecycle-ux-plan.md) | Plans / Follow-Ups | You are implementing the first read-only lifecycle labels and filters after dedup gate readiness |
...
| Implement read-only lifecycle UX | [`plans/read-only-lifecycle-ux-plan.md`](plans/read-only-lifecycle-ux-plan.md) | [`snapshots/dedup-provider-static-reconciliation-closure-2026-05-03.md`](snapshots/dedup-provider-static-reconciliation-closure-2026-05-03.md), [`source-policy-runbook.md`](source-policy-runbook.md), [`DATA_CONTRACT.md`](DATA_CONTRACT.md) |
