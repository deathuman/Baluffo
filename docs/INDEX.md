...
| [`plans/dedup-google-sheets-role-bucket-audit-plan.md`](plans/dedup-google-sheets-role-bucket-audit-plan.md) | Plans / Follow-Ups | You are auditing current-run Google Sheets role-bucket and weak identity dedup blockers before read-only lifecycle UX can proceed |
...
| Decide lifecycle UX readiness | [`plans/dedup-google-sheets-role-bucket-audit-plan.md`](plans/dedup-google-sheets-role-bucket-audit-plan.md) | [`snapshots/dedup-current-run-blocker-triage-closure-2026-05-03.md`](snapshots/dedup-current-run-blocker-triage-closure-2026-05-03.md), [`source-policy-runbook.md`](source-policy-runbook.md), [`DATA_CONTRACT.md`](DATA_CONTRACT.md) |
