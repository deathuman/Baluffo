...
> - **Last updated:** 2026-05-29 (added ats-custom-domain-detection high-priority plan)
...
| [`plans/ats-custom-domain-detection-plan.md`](plans/ats-custom-domain-detection-plan.md) | Plans / Follow-Ups | **High priority.** Detecting ATS providers (Teamtailor, Greenhouse, Workday, etc.) on custom domains like `careers.{studio}.com/jobs`. Fixes discovery pipeline HTML-signature detection, static adapter Playwright gate, and reclassifies ~60+ misregistered static sources. |
