...
| [`plans/ats-custom-domain-detection-plan.md`](plans/ats-custom-domain-detection-plan.md) | Plans / Follow-Ups | Core technical work shipped (Phases 1-6, 9 commits): HTML-signature detection, `/jobs` Playwright gate, ATS diagnostics, registry fixes, non-English keywords, JS shell detection, dead-listing retry. Remaining: manual audits (3b/3c) and architectural follow-ups (7). |
