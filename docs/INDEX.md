...
> - **Last updated:** 2026-05-29 (expanded static-inference plan with Phases 5-7)
...
| [`archive/static-plugin-simple-runner-migration-plan.md`](archive/static-plugin-simple-runner-migration-plan.md) | Plans / Follow-Ups | Archived — 5 plugins converted to SimpleStaticPlugin, 1 shared helper extracted, 10 plugins documented; all shipped to `main` 2026-05-28 |
...
| [`plans/ats-custom-domain-detection-plan.md`](plans/ats-custom-domain-detection-plan.md) | Plans / Follow-Ups | **High priority.** Broad static inference & ATS custom-domain detection: HTML signatures, domain heuristic, non-English keywords, broader Playwright gate, dead-listing retry, empty-page fallback, ATS feedback loop, re-probing, reclassification path, threshold reduction. Systemic fix across 7 phases. |
...
| [`archive/job-sanitization-plan-2026-05-18.md`](archive/job-sanitization-plan-2026-05-18.md) | Archived plan with closeout | Completed all P0–P3 phases: static noise rules, Google Sheets category-title detection, URL-slug repair, provider hydration, stale-link validation, bootstrap timeout fix, Remote OK guard, employer evidence (60→116 terms), sector-gate env var, dedup sparse-identity fix, company URL extraction (16 ATS hosts). All shipped to `main` by 2026-05-29. 506 tests pass. |
...
| Improve static inference and detect ATS on custom domains | [`plans/ats-custom-domain-detection-plan.md`](plans/ats-custom-domain-detection-plan.md) | [`provider_inference.py`](../src/source_discovery/provider_inference.py), [`web_search_candidates.py`](../src/source_discovery/web_search_candidates.py), [`static_listing.py`](../src/jobs/adapters/static_listing.py), [`testing.md`](testing.md) |
| Review completed job sanitization / filtering closeout | [`archive/job-sanitization-plan-2026-05-18.md`](archive/job-sanitization-plan-2026-05-18.md) | [`scraping-pipeline.md`](scraping-pipeline.md), [`DATA_CONTRACT.md`](DATA_CONTRACT.md), [`testing.md`](testing.md) |
