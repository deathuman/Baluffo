...
| [`archive/ats-custom-domain-detection-plan.md`](archive/ats-custom-domain-detection-plan.md) | Archived plan with closeout | All Phases 1-6 shipped (11 commits): HTML-signature detection, `/jobs` Playwright gate, ATS diagnostics, 21 registry reclassifications, non-English keywords, JS shell detection, dead-listing retry, empty-page fallback. Phase 7 parked. Closed 2026-05-29. |
