...
def test_sharded_python_test_families_do_not_use_star_helper_imports(repo_root: Path) -> None:
    for relative_path in (
        ...
        "tests/source_discovery/test_run_discovery_flow_candidates.py",
        "tests/source_discovery/test_run_discovery_flow_deferrals.py",
        "tests/source_discovery/test_run_discovery_flow_persistence.py",
        "tests/source_discovery/test_run_discovery_flow_runtime.py",
        "tests/jobs_static/test_browser_and_regression_queue_builders.py",
        "tests/jobs_static/test_browser_and_regression_queue_pipeline.py",
        "tests/jobs_static/test_browser_and_regression_queue_summaries.py",
