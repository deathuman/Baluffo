...
BRIDGE_ROUTES: tuple[BridgeRoute, ...] = (
    ...
    _route(
        "GET",
        "/desktop-local-data/availability-attention",
        EXACT,
        GET_LOCAL_DATA_HANDLER,
        "public",
        caller_files=LOCAL_DATA_CALLERS,
        verification="python -m pytest tests/bridge/test_job_availability_routes.py -q",
    ),
    _route(
        "GET",
        "/desktop-local-data/availability-overlay",
        EXACT,
        GET_LOCAL_DATA_HANDLER,
        "public",
        caller_files=LOCAL_DATA_CALLERS,
        verification="python -m pytest tests/test_local_data_store_availability.py -q",
    ),
    _route(
        "GET",
    ...
    _route(
        "GET",
        "/tasks/job-availability-check-status",
        EXACT,
        GET_PIPELINE_TASKS_HANDLER,
        "public",
        caller_files=(*PIPELINE_CALLERS, *LOCAL_DATA_CALLERS),
        verification="python -m pytest tests/bridge/test_job_availability_routes.py -q",
    ),
    _route(
        "GET",
    ...
    _route(
        "POST",
        "/desktop-local-data/availability-attention/acknowledge",
        EXACT,
        POST_LOCAL_DATA_HANDLER,
        "public",
        caller_files=LOCAL_DATA_CALLERS,
    ...
    _route(
        "POST",
        "/desktop-local-data/availability/report",
        EXACT,
        POST_LOCAL_DATA_HANDLER,
        "public",
        caller_files=LOCAL_DATA_CALLERS,
